...
var targetElement = document.querySelector(
  '[[Target Element Selector | string | .body | {required:true}]]'
);
  ...
  switch (position) {
    case 'top':
      bxTooltip.style.top =
        ...
        bxTooltip.offsetHeight -
        15 +
        'px';
      bxTooltip.style.left =
        targetElement.getBoundingClientRect().left +
        document.documentElement.scrollLeft +
        targetElement.offsetWidth / 2 -
        bxTooltip.offsetWidth / 2 +
        'px';
